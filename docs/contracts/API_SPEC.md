...
| 20 | GET | `/dashboard/layouts/{dashboardKey}` | 본인 저장 layout 또는 기본 layout 조회 | `DashboardLayoutDto` |
| 21 | PUT | `/dashboard/layouts/{dashboardKey}` | 본인 전체 layout revision upsert | `DashboardLayoutDto` |
| 22 | DELETE | `/dashboard/layouts/{dashboardKey}` | 본인 저장 layout 삭제·기본값 복귀 | `DashboardLayoutDto` |
| 23 | GET | `/operations/health` | 실시간 의존 서비스·Kafka Worker 상태 | `OperationsHealthDto` |
