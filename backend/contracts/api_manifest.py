...
PRODUCT_API_CONTRACTS: tuple[ApiContract, ...] = (
    ...
    ApiContract("GET", "/intelligence/forward-dns", "ForwardDnsQuery", "ForwardDnsDto", "JWT_READ"),
    ApiContract("GET", "/intelligence/reverse-dns", "ReverseDnsQuery", "ReverseDnsDto", "JWT_READ"),
    ApiContract("GET", "/intelligence/dns-lookup", "DnsLookupQuery", "DnsLookupDto", "JWT_READ"),
    ApiContract("GET", "/intelligence/correlate", "CorrelationQuery", "CorrelationDto", "JWT_READ"),
