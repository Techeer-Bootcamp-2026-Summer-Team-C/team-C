...
export function ArchivesPage() {
  ...
  return <div className="page-stack">
    ...
    {!hasCriteria ? <EmptyState title={t("archive.chooseRange")} message={t("archive.chooseRangeDescription")} /> : <QueryFeedback error={result.error} fetching={result.isFetching} hasData={Boolean(result.data)} invalid={invalid} invalidMessage={t("archive.chooseRangeDescription")} onRetry={() => void result.refetch()} pending={result.isPending && ready} refetchError={result.isRefetchError} rows={7} />}
