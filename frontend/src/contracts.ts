...
export type DashboardAvailabilityQuery = QueryOf<"dashboardGetAvailability">;
...
export type IncidentStatusUpdateRequest = Schemas["IncidentStatusUpdateRequest"];
...
export type DashboardAvailabilityDto = Schemas["DashboardAvailabilityDto"];
